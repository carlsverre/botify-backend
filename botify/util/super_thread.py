...
class SuperThread(threading.Thread):
    ...
    def __init__(self):
        super(SuperThread, self).__init__()
        self._starting = True
        self._stopping = threading.Event()
        self._stopped_by_stopping_exception = False
            ...
            try:
                while True:
                    try:
                        ...
                        self._stopped_by_stopping_exception = True
                        raise
    ...
    def work(self):
        """ `work()` runs until signalled to stop. """
    ...
    def pause(self, interval=None):
        if self._stopping.wait(interval if interval is not None else self.sleep):
    ...
    def interrupt_if_stopping(self):
        ...
        If `SuperThreadStoppingException` is raised in `work()` it
    ...
    def stopped_by_stopping_exception(self):
        return self._stopped_by_stopping_exception
